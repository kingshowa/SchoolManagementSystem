    ...
    <section class="content">
        ...
        <div class="content-form">
            <form action="authentification.php" method="post">
                ...
                <div class="champ">
                    <input type="text" name="login" placeholder="Code Enseignant" required autocomplete="new-password">
                </div>
                <div class="champ">
                    <input type="password" name="mdp" placeholder="Mot de passe" required autocomplete="new-password">
                </div>
                <div class="champ">
